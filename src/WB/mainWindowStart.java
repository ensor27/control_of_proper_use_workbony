...
public class mainWindowStart extends JFrame {
	...
	public mainWindowStart() {
		setResizable(false);
		setTitle("proper use of worknotes CUB4U");
		...
		JButton analizaGodzin = new JButton("Start experiment");
		...
		analizaGodzin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				// sprawdzenie daty zakonczenia
					...
					try {
						System.out.println("Start analyze worknotes");
						Main_class.createRaport();
						System.exit(0);
					} catch (Exception e) {
						e.printStackTrace();
					}
		...
		// Image img = new
		// ImageIcon(this.getClass().getResource("/BackgroundImage.jpg")).getImage();
